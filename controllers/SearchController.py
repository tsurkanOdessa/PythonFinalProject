...
def display_found_films():
    ...
    if request.method == 'POST':
        ...
        return render_template('index.html', genres=genres, films=films, top_queries=top_queries, recent_queries=recent_queries, actor=actor, genre=genre)

    genres = searcher_in_db.get_genres()
    top_queries = logger.get_top_queries()
    recent_queries = logger.get_recent_queries()
    return render_template('index.html', genres=genres, top_queries=top_queries, recent_queries=recent_queries, actor=None, genre=genre)
